...
class ProductService:
    ...
    @staticmethod
    def create_product(db: Session, product_in: schemas.ProductIn) -> schemas.ProductOut:
    ...
    @staticmethod
    def get_product_by_id(db: Session, product_id: int) -> schemas.ProductOut:
    ...
    @staticmethod
    def update_product(db: Session, product_id: int, product_in: schemas.ProductUpdate) -> schemas.ProductOut:
        product = crud.get_product_by_id(db, product_id)
    ...
    @staticmethod
    def delete_product(db: Session, product_id: int) -> any:
        product = crud.get_product_by_id(db, product_id)
        if not product:
            raise APIException(
                message=f'Product with ID: {product_id} not found',
